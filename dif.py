...
img1 = cv2.imread('./image/castle1.png',0) #日別.pngをグレースケールで読み込む
img2 = cv2.imread('./image/castle2.png',0) #キャンペーン別.pngをグレースケールで読み込む
...
cv2.imwrite('./image/difference_ex.png',difference) #ファイル名difference.pngでdifferenceを保存  
